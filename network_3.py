...
class Router:
    ...
    def __init__(self, routes, name, intf_count, max_queue_size):
        self.stop = False  # for thread termination
        self.name = name
        ...
        for i in range(len(self.in_intf_L)):
            ...
            try:
                ...
                if pkt_S is not None:
                    ...
                    addr = string_data[1:5]
                    addr = int(addr)
                    outInterface = self.routes.get(addr)        #implemented a lookup into the forwarding table
